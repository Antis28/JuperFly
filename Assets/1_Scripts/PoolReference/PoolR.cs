...
public class PoolR : MonoBehaviour
{
    ...
    [HideInInspector]
    public Image SrollRect;
    [HideInInspector]
    public TaskManeger    taskManeger;
    ...
    [HideInInspector]
    public Text   BonusTextTask;

    [HideInInspector]
    public Image  PriceImageTask;
    [HideInInspector]
    public Image  taskImage;
    [HideInInspector]
    public Image  BonusImageTask;
    ...
    [HideInInspector]
    public Button     AnswerTaskButton;
    [HideInInspector]
    ...
    [HideInInspector]
    public Image      FlyImageTask;
    [HideInInspector]
    public BonusControler bonusControler;
    [HideInInspector]
    public LoadStats loadStats;
    [HideInInspector]
    public SimplePlatformContoroler simplePlatformContoroler;
    [HideInInspector]
    public Shop shop;
    [HideInInspector]
    ...
    [HideInInspector]
    public InputField AnswerChislitelInputField;
    [HideInInspector]
    public InputField AnswerZnamenatelInputField;
